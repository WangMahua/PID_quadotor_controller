function trust_d = altitude_control_debug(pz_d,vz_d,az,pz,vz,R,t,P)
...
trust_d = P.mass *(P.gravity-1*pos_error-0.1*integratedAltitudeError-0.2*pos_error_d)/R(3,3);
